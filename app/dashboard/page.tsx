        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-muted-foreground">総神様数</p>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-muted-foreground">総メッセージ数</p>
            ...
            <CardContent>
              {recentMessages.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <Link href="/gods">
                    <Button className="bg-purple-600 hover:bg-purple-700">神様と対話する</Button>
                  </Link>
                </div>
              ) : (
                <div className="space-y-4">
